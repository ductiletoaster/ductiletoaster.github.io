          ...
          <div className={styles.row}>
            ...
            <div className={`${styles.information} ${styles.column}`}>
              ...
              <div className={styles.timeline}>
                ...
                <p>
                  Manage the Identity Platform Team
                  <ul>
                    <li>
                    ...
                    <li>
                      ...
                      Party IAM solution with the goal to implement Adaptive
                      MFA, SSO, Social Sign On, Biometrics, and more.
                    </li>
                  </ul>
                </p>
                <p>
                  Established Comms Platform Team
                  <ul>
                    <li>
                      Collaborated with the product management team &
                      engineering leadership to propose and create the Comms
                      Platform.
                    </li>
                    <li>
                ...
                <p>
                  ...
                  <ul>
                    <li>
                      Collaborated closely with another team to deliver a
                      seamless credit card checkout flow redesign.
                    </li>
                    <li>
                ...
                <p>
                  Technical Lead on Critical Projects
                  <ul>
                    <li>
                ...
                <p>
                  ...
                  <ul>
                    <li>
                      Led the development team in a full redesign of the
                      campaign page and supporting API, handling high traffic
                      and concurrent requests efficiently.
                    </li>
                  </ul>
                </p>
                ...
                <p>
                  Internal Tool & Service Development
                  <ul>
                    <li>
                      Contributed to the development of internal tools,
                      including moderation tools for reviewing customer images
                      and content.
                    </li>
                    <li>
              ...
              <div className={styles.timeline}>
                ...
                <p>
                  ...
                  <ul>
                    ...
                    <li>
                      Managed server monitoring, web page speed testing,
                      automated alerting, real-time data analytics, conversion
                      tracking, and user behavior reporting.
                    </li>
                  </ul>
                </p>
                <p>
                  ...
                  <ul>
                    <li>
                      ...
                      alerts & reports, and consumed millions of user events
                      each month.
                    </li>
                    <li>
              ...
              <div className={styles.timeline}>
                ...
                <p>
                  Custom Reporting and Testing Systems
                  <ul>
                    <li>
              ...
              <div className={styles.timeline}>
                ...
                <p>
                  Transition to Part-Time Position
                  <ul>
                    <li>
                ...
                <p>
                  Administrative and Software Support
                  <ul>
                    <li>
                      Provided crucial administrative support for the company's
                      software systems, managing dispatching, payroll, and
                      various essential software services.
                    </li>
                    <li>
                      Integrated new infrastructure technologies, such as
                      printers, fax machines, computers, centralized data
                      backup, and company phone & email services.
                    </li>
                  </ul>
                </p>
                <h5>Web Developer</h5>
                ...
                <p>
                  ...
                  <ul>
                    <li>
                      Established the brand "Lost Propaganda" (later rebranded
                      as PixelOven) during this time.
                    </li>
                    <li>
